...
import { Plus, Minus, ArrowUp, Search, X } from 'lucide-react';
...
export function SearchMenu() {
    const { isOpen, setIsOpen, setSearchTerm, searchResults } = useSearch();
    ...
    const content = (
        <div className='flex h-full w-full flex-col overflow-hidden py-4'>
            ...
            <footer className='mt-5 mb-3 flex flex-shrink-0 flex-col'>
                <form
                    className='relative'
                    action='submit'
                    onSubmit={(e) => {
